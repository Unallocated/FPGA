...
xst -ifn xst.scr
move mojo_clock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\mojo_clock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc mojo_clock_exdes.ucf mojo_clock_exdes

echo 'Running map'
map -timing -pr b mojo_clock_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm mojo_clock_exdes -w routed.ncd routed.vhd
cd ..
